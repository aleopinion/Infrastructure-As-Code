# https://registry.terraform.io/providers/hashicorp/google/latest/docs# Terraform Settings Block
# Hashicorp Google Registry: https://registry.terraform.io/providers/hashicorp/google/latest
terraform {
  required_version = "~> 1.1.8" # Terraform version constrain: This is the Required Terraform version while
